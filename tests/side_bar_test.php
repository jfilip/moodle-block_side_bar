...
class blockSideBarTestcase extends advanced_testcase {
    ...
    public function test_create_section_works_with_no_orphaned_sections() {
        ...
        $sbsection = $DB->get_record('course_sections', array('id' => $sectioninfo->id),
                'section, name, summary, visible');
     ...
     * orphaned sections but only the "highest" orphaned section contains an activity module (orphaned being sections that exist
     * beyond the number of sections configured for the course).
     */
    ...
    /**
     * Test that the Side Bar block activity section is appropriately added to a course when that course contains multiple
     * orphaned sections but only the "lowest" orphaned section contains an activity module (orphaned being sections that exist
     * beyond the number of sections configured for the course).
     */
